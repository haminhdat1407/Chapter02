module.exports = {
    ...
    init(parser, reporter, options) {
        const arrRules = {
            underline: {
                regId: /^[a-z\d]+(_[a-z\d]+)*$/,
                message: 'The class attribute values must be in lowercase and split by an underscore.',
            },
            dash: {
                regId: /^[a-z\d]+(-[a-z\d]+)*$/,
                message: 'The class attribute values must be in lowercase and split by a dash.',
            },
            hump: {
